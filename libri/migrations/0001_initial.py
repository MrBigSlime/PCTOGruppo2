# Generated by Django 3.1.5 on 2021-02-09 08:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autPostfazione', models.CharField(max_length=256)),
                ('autPrefazione', models.CharField(max_length=256)),
            ],
        ),
        migrations.CreateModel(
            name='Scaffale',
        ...
        migrations.AddField(
            model_name='seriale',
            name='Critico',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='criticoS', to='libri.tradautcur'),
        ),
        migrations.AddField(
            model_name='seriale',
        ...
        migrations.AddField(
            model_name='seriale',
            name='IDCollana',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='libri.collane'),
        ),
        migrations.AddField(
            model_name='seriale',
            name='IDPostPrefazione',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='libri.postfazionepre'),
        ),
        migrations.AddField(
            model_name='seriale',
            name='Traduttore',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='traduttoreS', to='libri.tradautcur'),
        ),
        migrations.CreateModel(
            name='Prestito',
            fields=[
        ...
        migrations.AddField(
            ...
            name='Critico',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='criticoN', to='libri.tradautcur'),
        ),
        migrations.AddField(
            model_name='nonseriale',
            name='IDAutoreCuratore',
        ...
        migrations.AddField(
            model_name='nonseriale',
            name='Traduttore',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='traduttoreN', to='libri.tradautcur'),
        ),
    ]
